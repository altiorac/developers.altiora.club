        ...
        <div className="w-screen h-screen flex flex-col justify-center text-center items-center mt-28 cursor-default">
            ...
            <div className="flex mt-30 gap-6 -ml-4">
                <div className="rounded-full transition-colors">
                    <TextScroller href="/teams" items={[<span key="teams-primary" className="py-0.5 px-4">TEAMS</span>, <span key="teams-hover" className="py-0.5 px-4">TEAMS</span>]} interaction="hover" className="text-base tracking-tighter uppercase h-8 bg-neutral-900 rounded-full font-standard" textAlign="center" />
                </div>
