...
export default function TeamPage({ title, description, content, next, image }: { title: string; description: ReactNode; content: ReactNode; next: string; image: StaticImageData }) {
    ...
    return (
        <div>
            ...
            <div className="w-screen h-screen flex flex-col justify-center text-center items-center">
                <CursorBadge>
                    <Link href={`/teams/${nextProjectSlug}`}>
