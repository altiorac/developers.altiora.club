        ...
        <div className="w-full min-h-screen bg-background text-foreground pt-40">
            <main className="container mx-auto max-w-3xl px-6">
                ...
                <motion.div initial={{ y: -20, opacity: 0 }} animate={{ y: 0, opacity: 1 }} transition={{ duration: 1, ease: "easeOut", delay: 0.2 }}>
                    ...
                    <p className="font-standard text-lg md:text-xl text-foreground/80 max-w-2xl">We are the AI vanguard of the Development Division. Our work exists at the nexus of data, algorithms, and human ambition, crafting intelligent systems that power the future of Altiora.</p>
                </motion.div>
                ...
                <motion.div className="mt-24 flex flex-col gap-20" variants={containerVariants} initial="hidden" animate="visible">
                    ...
                    <Section>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-10">
                            <div className="flex flex-col">
                                ...
                                <p className="font-standard text-foreground/70 text-sm md:text-base">Developing and fine-tuning novel algorithms for predictive analytics, natural language processing, and computer vision. This is our lab, where theory becomes reality.</p>
                            </div>
                            <div className="flex flex-col">
                                <h3 className="font-standard tracking-widest text-base mb-2">APPLIED AI SOLUTIONS</h3>
                                <p className="font-standard text-foreground/70 text-sm md:text-base">Integrating intelligent systems into divisional workflows. From algorithmic trading for Finance to generative art for Creatives, we build practical, high-impact tools.</p>
                            </div>
                            <div className="flex flex-col">
                                <h3 className="font-standard tracking-widest text-base mb-2">DATA INFRASTRUCTURE</h3>
                                <p className="font-standard text-foreground/70 text-sm md:text-base">Architecting robust data pipelines and scalable infrastructure. We ensure the seamless flow of high-quality data that is the lifeblood of every intelligent system.</p>
                            </div>
                            <div className="flex flex-col">
                                <h3 className="font-standard tracking-widest text-base mb-2">AI ETHICS & STRATEGY</h3>
                                <p className="font-standard text-foreground/70 text-sm md:text-base">Guiding the responsible implementation of AI. We focus on fairness, transparency, and the long-term strategic implications of our work across the organization.</p>
                            </div>
                        </div>
                    </Section>
                    ...
                    <Section>
                        ...
                        <p className="font-standard text-foreground/80 text-base md:text-lg mb-6">We employ a state-of-the-art toolkit to execute our vision, selecting the best instrument for each unique challenge.</p>
                    ...
                    <motion.div variants={itemVariants} className="pt-10 pb-24">
                        ...
                        <p className="font-standard text-foreground/60 mt-4 text-sm md:text-base">Have a mission that requires intelligent systems? Submit a dispatch request to our team.</p>
                    </motion.div>

                    <div className="w-full h-[1px] bg-foreground/30" />
                    <NextTeamSection currentTeamSlug="ai" />
                </motion.div>
            </main>
            <Footer />
        </div>
